...
#define MOTOR0_FORWARD                  IN1_PIN
#define MOTOR0_BACKWARD                 IN2_PIN
#define MOTOR1_FORWARD                  IN3_PIN
#define MOTOR1_BACKWARD                 IN4_PIN

#define MOTOR0                          (IN1_PIN|IN2_PIN)
#define MOTOR1                          (IN3_PIN|IN4_PIN)
...
//void Update_Speed(int8_t i8_M0Duty, int8_t i8_M1Duty);
